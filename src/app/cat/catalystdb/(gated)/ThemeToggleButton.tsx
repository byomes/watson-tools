...
// Same toggle as the deacon app's (deaconTheme.ts / DeaconAppTabs), just
// pointed at catalystdbTheme's own hook/storage key.
export default function ThemeToggleButton() {
  const [theme, toggleTheme] = useCatalystDBTheme()
  return (
    <button
      type="button"
      onClick={toggleTheme}
